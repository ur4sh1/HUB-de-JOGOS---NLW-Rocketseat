...
function App() {
  ...
  return (
    <div className='max-w-[1480px] mx-auto flex flex-col items-center my-20'>
      <img src={logoImg} alt='' />

      <h1 className='text-6xl text-white font-black m-20 mt-4'>
        Seu <span className='bg-nlw-gradiente text-transparent bg-clip-text'>duo</span> está aqui.
        </h1>
